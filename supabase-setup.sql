-- FIRE Planner POC Schema for Supabase
...
CREATE TABLE IF NOT EXISTS super_balances_poc (
  ...
  -- Growth assumptions
  assumed_annual_return DECIMAL DEFAULT 0.07,
  annual_fees DECIMAL DEFAULT 0.007,
...
CREATE TABLE IF NOT EXISTS fire_projections_poc (
  ...
  -- Key milestones
  super_preservation_year INTEGER,
  loan_payoff_year INTEGER,
  fire_achievement_year INTEGER,
  
  -- Super projections
  super_balance_at_preservation DECIMAL,
  super_balance_at_fire DECIMAL,
